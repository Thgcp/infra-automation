...
**[Demonstração dos Menus]**(https://github.com/Thgcp/infra-automation/releases/download/infra-automation/Demonstracao.gif)

**[Demonstração de botões auxiliares]**()
...
*Desenvolvido para a de Infraestrutura - Hospital Nipo Brasileiro* 🏥